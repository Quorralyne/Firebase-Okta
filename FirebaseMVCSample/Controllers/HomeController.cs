...
using FirebaseMVCSample.Models;
using System;
...
namespace FirebaseMVCSample.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> About()
        {
            ...
            var firebaseClient = new FirebaseClient("https://fir-mvcsample.firebaseio.com/");
            var result = await firebaseClient.Child("Users/" + userOktaId + "/Logins").PostAsync(currentUserLogin);

            //Retrieve data from Firebase
            var dbLogins = await firebaseClient.Child("Users").Child(userOktaId).Child("Logins").OnceAsync<LoginData>();
